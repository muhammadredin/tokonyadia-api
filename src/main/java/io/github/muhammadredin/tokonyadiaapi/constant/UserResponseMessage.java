...
public class UserResponseMessage {
    ...
    public static final String USER_LOGIN_ERROR = "Bad Credentials";
    public static final String USER_LOGOUT_SUCCESS = "User logged out successfully";
    public static final String USER_FORGOT_PASSWORD_SUCCESS = "Successfully send forgot password request";
    public static final String USER_CHANGE_PASSWORD_SUCCESS = "Successfully changed password";
}
